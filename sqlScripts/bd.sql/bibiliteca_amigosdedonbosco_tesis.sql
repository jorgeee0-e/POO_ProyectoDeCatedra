...
CREATE TABLE `tesis` (
  ...
  KEY `fk_tesis_curso` (`curso_id`),
  KEY `fk_tesis_id_autor` (`id_autor`),
  KEY `id_material` (`id_material`),
  CONSTRAINT `fk_tesis_curso` FOREIGN KEY (`curso_id`) REFERENCES `categorias` (`curso_id`),
  CONSTRAINT `fk_tesis_id_autor` FOREIGN KEY (`id_autor`) REFERENCES `autor` (`id_autor`),
  CONSTRAINT `tesis_ibfk_1` FOREIGN KEY (`id_material`) REFERENCES `materiales` (`id_material`)
