...
CREATE TABLE `libros` (
  ...
  KEY `fk_libros_id_material` (`id_material`),
  CONSTRAINT `fk_libros_curso` FOREIGN KEY (`curso_id`) REFERENCES `categorias` (`curso_id`),
  CONSTRAINT `fk_libros_id_material` FOREIGN KEY (`id_libro`) REFERENCES `materiales` (`id_material`)
...
-- Dump completed on 2024-05-17 18:46:07
