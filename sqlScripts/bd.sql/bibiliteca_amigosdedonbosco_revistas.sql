...
CREATE TABLE `revistas` (
  ...
  KEY `fk_revistas_id_autor` (`id_autor`),
  KEY `id_material` (`id_material`),
  CONSTRAINT `fk_revistas_curso` FOREIGN KEY (`curso_id`) REFERENCES `categorias` (`curso_id`),
  CONSTRAINT `fk_revistas_id_autor` FOREIGN KEY (`id_autor`) REFERENCES `autor` (`id_autor`),
  CONSTRAINT `revistas_ibfk_1` FOREIGN KEY (`id_material`) REFERENCES `materiales` (`id_material`)
