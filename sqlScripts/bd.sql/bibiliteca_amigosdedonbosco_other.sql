...
CREATE TABLE `other` (
  ...
  KEY `fk_other_id_autor` (`id_autor`),
  KEY `id_material` (`id_material`),
  CONSTRAINT `fk_other_id_autor` FOREIGN KEY (`id_autor`) REFERENCES `autor` (`id_autor`),
  CONSTRAINT `other_ibfk_1` FOREIGN KEY (`id_material`) REFERENCES `materiales` (`id_material`)
